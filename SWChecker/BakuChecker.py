import os.path
from SWChecker.BaseChecker import *
    ...
    def check(self, text):
        ...
        for element in self.dict:
            ...
            while(textLower.find(element[1], i)!=-1):
                ...
                # errList.append(ErrorMessage(self, self.slice(text, i, len(element[1])), "The correct word for '{}' is '{}'".format(element[1], element[0]), output))
                errList.append(ErrorMessage(self, element[1], element[0]))
                i += len(element[1])
